...
import ru.aston.homework.intensive.userservice.util.ValidationUtil;
...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, KafkaEventService kafkaEventService) {
    ...
    public UserResponseDto createUser(CreateUserDto createUserDto) {
        ...
        try {
            ...
            kafkaEventService.sendUserEvent("CREATE", savedUser.getEmail(), savedUser.getId());
    ...
    public void deleteUser(Long id) {
        ...
        kafkaEventService.sendUserEvent("DELETE", userEmail, id);
